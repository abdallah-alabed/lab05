...
Test this function by hand in the console to get it working, and when you think it is finished, uncomment the call for the testSum() function
 below and check the console to see if the test passes.*/
...
let sumTotal=a+b+c;
let sumProd=a*b*c;
return [sumTotal,sumProd, `${a} and ${b} and ${c} sum to ${sumTotal}.`, `The product of ${a} and ${b} and ${c} is ${sumProd}.`]
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    for (let i=0 ; i<length ; i++){
        ...
        first =multiply(dynamicArray[i],1)
        final =multiply(final[0],first[0])
       // console.log([final[0],`The product of ${multArr.toString()} is ${final[0]}.`])
 }
 return [final[0],`The numbers ${dynamicArray.toString()} have a product of ${final[0]}.`];
}
